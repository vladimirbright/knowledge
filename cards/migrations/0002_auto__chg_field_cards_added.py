...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cards.added'
        db.alter_column('cards_cards', 'added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Cards.added'
        db.alter_column('cards_cards', 'added', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'cards.cardfavorites': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 27, 22, 32, 52, 589397)'}),
